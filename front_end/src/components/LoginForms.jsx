        ...
        {!error && (<div className="w-full md:w-1/2 animate-fade-in">
          ...
          <form onSubmit={handleLogin} className = "space-y-5">
            ...
            <div>
              ...
              <div className = "relative"> 
                ...
                <button type="button" onClick={() => setShowPassword(!showPassword)}
                  className = "cursor-pointer absolute right-0 top-0 translate-y-2.5 -translate-x-2 text-slate-600">
            ...
            <button type="submit" onClick={handleLogin()}
              disabled={loading}
              className = "text-xs md:text-sm disabled-50 flex w-full justify-center \
              py-2 bg-slate-600 text-slate-200 rounded-full hover:bg-slate-700 cursor-pointer" >
